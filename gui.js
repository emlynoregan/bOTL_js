...
edSource.setValue(getStoredText("sourceText", JSON.stringify(testsJson["sources"]["source1"], null, 2)))
edSource.gotoLine(0);
edTransform.setValue(getStoredText("transformText", JSON.stringify(testsJson["transforms"]["synopsis"], null, 2)))
